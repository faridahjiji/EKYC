var app = {
  startCameraAbove: function(){
    CameraPreview.startCamera({x: 50, y: 50, width: 300, height: 300, toBack: false, previewDrag: null, tapPhoto: true});
  },

  startCameraBelow: function(){
    CameraPreview.startCamera({x: 50, y: 50, width: 500, height:500, camera: "front", tapPhoto: true, previewDrag: null, toBack: true});
  },
  ...
  takePicture: function(){
    CameraPreview.takePicture(function(imgData){
	  ...
	  CameraPreview.takePicture(function(imgData){
      document.getElementById('originalPicture1').src = 'data:image/jpeg;base64,' + imgData;
	  CameraPreview.takePicture(function(imgData){
      document.getElementById('originalPicture2').src = 'data:image/jpeg;base64,' + imgData;
	  CameraPreview.stopCamera();
	  });
	  });
    });
